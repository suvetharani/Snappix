  ...
  return (
    <>
      {isMobile ? (
        ...
        >
    <main className="max-w-4xl min-w-[330px] mx-auto p-4 pb-20 bg-white dark:bg-black dark:text-white min-h-screen transition-colors duration-300 w-full min-w-0">
      ...
      <div className="flex flex-col items-center gap-4 mb-4">
        ...
        />
        <h2 className="text-3xl font-bold mt-2 mb-2 text-center">{user.username}</h2>
        <p className="text-center">{user.bio || "Add a bio!"}</p>
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-80 flex flex-col items-center justify-center z-50 overflow-y-auto">
                    <div className="bg-white dark:bg-black dark:text-white rounded shadow-md flex flex-col w-full max-w-md mx-auto relative overflow-hidden" style={{maxHeight: '95vh'}}>
                      ...
                      <div className="p-4 flex-1 flex flex-col min-w-0 max-w-full relative overflow-y-auto" style={{maxHeight: 'calc(95vh - 360px)'}}>
                        <h2 className="font-semibold mb-1">{[selectedPost.username, ...(selectedPost.collaborators || [])].join(', ')}</h2>
                  ...
                  <ul className="space-y-2">
                    {user.followers.map(f => (
                      <li
                        ...
                        className="flex items-center gap-2 p-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-neutral-800 rounded"
                      >
                        <img
                  ...
                  <ul className="space-y-4">
                    {user.following.map((f, i) => (
                      <li
                        ...
                        className="flex items-center gap-3 p-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-neutral-800 rounded"
                      >
                        <img
